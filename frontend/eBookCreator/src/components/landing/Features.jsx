...
<div className="absolute inset-0 bg-linear-to-br from-violet-50/50 via-transparent to-purple-50/50"></div>
    ...
    <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {FEATURES.map((feature, index) => {
          ...
          return (
            <div
              key={index}
              className="group relative bg-white rounded-2xl p-8 border-gray-100 hover:border-violet-200 transition-all duration-300 hover:shadow-xl hover:shadow-violet-500/10 hover:-translate-y-1"
            >
              ...
              <div className="relative space-y-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 leading-relaxed text-5m">
                    {feature.description}
                  </p>
                </div>
      ...
      <div className="text-center mt-16">
        ...
        <a
          href="/signup"
          className="inline-flex items-center space-x-2 bg-linear-to-r from-violet-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold shadow-lg shadow-violet-500/30 hover:shadow-violet-500/50 hover:scale-150 transition-all duration-200"
        >
