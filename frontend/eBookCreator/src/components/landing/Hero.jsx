...
const Hero = () => {
  ...
  return <div className="relative bg-linear-to-br from-violet-50 via-white to-purple-50 overflow-hidden">
        ...
        <div className="max-w-xl space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <Link
              ...
              className="group inline-flex items-center space-x-2 bg-linear-to-r from-violet-600 to bg-purple-600 text-white px-8 py-4 rounded-xl font-semibold shadow-violet-500/30 hover:shadow-violet-500/50 hover:scale-105 transition-all duration-200">
        ...
        <div className="relative lg:pl-8">
          <div className="relative">
            ...
            <div className="relative bg-white rounded-xl shadow-xl overflow-hidden border border-gray-100">
              ...
              <div className="absolute top-6 right-6 bg-white rounded-2xl shadow-xl p-4 backdrop-blur-sm border border-gray-100 animate-in fade-in slide-in-from-right duration-700">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-linear-to-br from-violet-500 to-purple-600 rounded-lg flex items-center justify-center">
                    <Zap className="2-5 h-5 text-white" />
                  </div>
                  <div>
              ...
              <div className="absolute bottom-6 left-6 bg-white rounded-2xl p-4 nackdrop-blur-sm border border-gray-100 animate-in fade-in slide-in-left duration-700 delay-300">
                <div className="flex items-items-center space-x-3">
